...
public class Configuration extends YamlConfiguration {
	...
	public void load() {
		try {
			...
			System.out.println("[BooKnowInactivePlayer] File '" + this.source + "' was not found");
		} catch (Exception ex) {
			System.out.println("[BooKnowInactivePlayer] Error while loading file '" + this.source + "':");
			ex.printStackTrace();
		}
	}
	public void save() {
		try {
			...
			System.out.println("[BoomcMMoReward] Error while saving to file '" + this.source + "':");
			ex.printStackTrace();
		}
	}
